...
${OBJECTDIR}/ActionIF.o: ActionIF.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActionIF.o ActionIF.cpp
...
${OBJECTDIR}/MapOfAction.o: MapOfAction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapOfAction.o MapOfAction.cpp
...
${TESTDIR}/tests/ActionIFtestclass.o: tests/ActionIFtestclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ActionIFtestclass.o tests/ActionIFtestclass.cpp


${TESTDIR}/tests/ActionIFtestrunner.o: tests/ActionIFtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ActionIFtestrunner.o tests/ActionIFtestrunner.cpp
...
${OBJECTDIR}/ActionIF_nomain.o: ${OBJECTDIR}/ActionIF.o ActionIF.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActionIF_nomain.o ActionIF.cpp;\
	else  \
...
${OBJECTDIR}/MapOfAction_nomain.o: ${OBJECTDIR}/MapOfAction.o MapOfAction.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapOfAction_nomain.o MapOfAction.cpp;\
	else  \
