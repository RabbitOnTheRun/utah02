...
${OBJECTDIR}/ActionIF.o: ActionIF.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActionIF.o ActionIF.cpp
...
${OBJECTDIR}/ExternalEffect.o: ExternalEffect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExternalEffect.o ExternalEffect.cpp
...
${OBJECTDIR}/MapOfAction.o: MapOfAction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapOfAction.o MapOfAction.cpp
...
${OBJECTDIR}/OutPort.o: OutPort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutPort.o OutPort.cpp

${OBJECTDIR}/Port.o: Port.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Port.o Port.cpp

${OBJECTDIR}/PortConnection.o: PortConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PortConnection.o PortConnection.cpp

${OBJECTDIR}/PortMap.o: PortMap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PortMap.o PortMap.cpp
...
${OBJECTDIR}/Result.o: Result.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Result.o Result.cpp

${OBJECTDIR}/ResultHandling.o: ResultHandling.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResultHandling.o ResultHandling.cpp
...
${OBJECTDIR}/Sym.o: Sym.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sym.o Sym.cpp
...
${OBJECTDIR}/Value.o: Value.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Value.o Value.cpp

${OBJECTDIR}/jsonMapper/ExternalEffectMapper.o: jsonMapper/ExternalEffectMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ExternalEffectMapper.o jsonMapper/ExternalEffectMapper.cpp
...
${OBJECTDIR}/jsonMapper/InOutPortMapper.o: jsonMapper/InOutPortMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/InOutPortMapper.o jsonMapper/InOutPortMapper.cpp
...
${OBJECTDIR}/jsonMapper/MessageEmissionMapper.o: jsonMapper/MessageEmissionMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/MessageEmissionMapper.o jsonMapper/MessageEmissionMapper.cpp
...
${OBJECTDIR}/jsonMapper/PortMapMapper.o: jsonMapper/PortMapMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/PortMapMapper.o jsonMapper/PortMapMapper.cpp

${OBJECTDIR}/jsonMapper/ProcessMapper.o: jsonMapper/ProcessMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ProcessMapper.o jsonMapper/ProcessMapper.cpp
...
${OBJECTDIR}/jsonMapper/ThreadMapper.o: jsonMapper/ThreadMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ThreadMapper.o jsonMapper/ThreadMapper.cpp
...
${TESTDIR}/tests/ExternalEffectMappertestclass.o: tests/ExternalEffectMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ExternalEffectMappertestclass.o tests/ExternalEffectMappertestclass.cpp


${TESTDIR}/tests/ExternalEffectMappertestrunner.o: tests/ExternalEffectMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ExternalEffectMappertestrunner.o tests/ExternalEffectMappertestrunner.cpp


${TESTDIR}/tests/GuardIFtestclass1.o: tests/GuardIFtestclass1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GuardIFtestclass1.o tests/GuardIFtestclass1.cpp


${TESTDIR}/tests/GuardIFtestrunner1.o: tests/GuardIFtestrunner1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GuardIFtestrunner1.o tests/GuardIFtestrunner1.cpp
...
${TESTDIR}/tests/MessageEmissiontestclass.o: tests/MessageEmissiontestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MessageEmissiontestclass.o tests/MessageEmissiontestclass.cpp


${TESTDIR}/tests/MessageEmissiontestrunner.o: tests/MessageEmissiontestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MessageEmissiontestrunner.o tests/MessageEmissiontestrunner.cpp
...
${TESTDIR}/tests/PortMapMappertestclass.o: tests/PortMapMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PortMapMappertestclass.o tests/PortMapMappertestclass.cpp


${TESTDIR}/tests/PortMapMappertestrunner.o: tests/PortMapMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PortMapMappertestrunner.o tests/PortMapMappertestrunner.cpp


${TESTDIR}/tests/ProcessMapperPushtestclass.o: tests/ProcessMapperPushtestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMapperPushtestclass.o tests/ProcessMapperPushtestclass.cpp


${TESTDIR}/tests/ProcessMapperPushtestrunner.o: tests/ProcessMapperPushtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMapperPushtestrunner.o tests/ProcessMapperPushtestrunner.cpp


${TESTDIR}/tests/ProcessMappertestclass.o: tests/ProcessMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMappertestclass.o tests/ProcessMappertestclass.cpp


${TESTDIR}/tests/ProcessMappertestrunner.o: tests/ProcessMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMappertestrunner.o tests/ProcessMappertestrunner.cpp


${TESTDIR}/tests/ResultHandlingtestclass.o: tests/ResultHandlingtestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ResultHandlingtestclass.o tests/ResultHandlingtestclass.cpp


${TESTDIR}/tests/ResultHandlingtestrunner.o: tests/ResultHandlingtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ResultHandlingtestrunner.o tests/ResultHandlingtestrunner.cpp


${TESTDIR}/tests/StateMachineMappertestclass.o: tests/StateMachineMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StateMachineMappertestclass.o tests/StateMachineMappertestclass.cpp
...
${TESTDIR}/tests/ThreadMapper2testclass.o: tests/ThreadMapper2testclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMapper2testclass.o tests/ThreadMapper2testclass.cpp


${TESTDIR}/tests/ThreadMapper2testrunner.o: tests/ThreadMapper2testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMapper2testrunner.o tests/ThreadMapper2testrunner.cpp


${TESTDIR}/tests/ThreadMappertestclass.o: tests/ThreadMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMappertestclass.o tests/ThreadMappertestclass.cpp
...
${TESTDIR}/tests/TransitionPartMappertestclass.o: tests/TransitionPartMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TransitionPartMappertestclass.o tests/TransitionPartMappertestclass.cpp


${TESTDIR}/tests/TransitionPartMappertestrunner.o: tests/TransitionPartMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TransitionPartMappertestrunner.o tests/TransitionPartMappertestrunner.cpp
...
${OBJECTDIR}/ActionIF_nomain.o: ${OBJECTDIR}/ActionIF.o ActionIF.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActionIF_nomain.o ActionIF.cpp;\
	else  \
...
${OBJECTDIR}/ExternalEffect_nomain.o: ${OBJECTDIR}/ExternalEffect.o ExternalEffect.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExternalEffect_nomain.o ExternalEffect.cpp;\
	else  \
...
${OBJECTDIR}/MapOfAction_nomain.o: ${OBJECTDIR}/MapOfAction.o MapOfAction.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapOfAction_nomain.o MapOfAction.cpp;\
	else  \
...
${OBJECTDIR}/MessageEmission_nomain.o: ${OBJECTDIR}/MessageEmission.o MessageEmission.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageEmission_nomain.o MessageEmission.cpp;\
	else  \
...
${OBJECTDIR}/OutPort_nomain.o: ${OBJECTDIR}/OutPort.o OutPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutPort_nomain.o OutPort.cpp;\
	else  \
...
${OBJECTDIR}/Port_nomain.o: ${OBJECTDIR}/Port.o Port.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Port_nomain.o Port.cpp;\
	else  \
...
${OBJECTDIR}/PortConnection_nomain.o: ${OBJECTDIR}/PortConnection.o PortConnection.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PortConnection_nomain.o PortConnection.cpp;\
	else  \
...
${OBJECTDIR}/PortMap_nomain.o: ${OBJECTDIR}/PortMap.o PortMap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PortMap_nomain.o PortMap.cpp;\
	else  \
...
${OBJECTDIR}/Process_nomain.o: ${OBJECTDIR}/Process.o Process.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Process_nomain.o Process.cpp;\
	else  \
...
${OBJECTDIR}/Result_nomain.o: ${OBJECTDIR}/Result.o Result.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Result_nomain.o Result.cpp;\
	else  \
...
${OBJECTDIR}/ResultHandling_nomain.o: ${OBJECTDIR}/ResultHandling.o ResultHandling.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResultHandling_nomain.o ResultHandling.cpp;\
	else  \
...
${OBJECTDIR}/StateMachine_nomain.o: ${OBJECTDIR}/StateMachine.o StateMachine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StateMachine_nomain.o StateMachine.cpp;\
	else  \
...
${OBJECTDIR}/Sym_nomain.o: ${OBJECTDIR}/Sym.o Sym.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sym_nomain.o Sym.cpp;\
	else  \
...
${OBJECTDIR}/Value_nomain.o: ${OBJECTDIR}/Value.o Value.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Value_nomain.o Value.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/ExternalEffectMapper_nomain.o: ${OBJECTDIR}/jsonMapper/ExternalEffectMapper.o jsonMapper/ExternalEffectMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ExternalEffectMapper_nomain.o jsonMapper/ExternalEffectMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/InOutPortMapper_nomain.o: ${OBJECTDIR}/jsonMapper/InOutPortMapper.o jsonMapper/InOutPortMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/InOutPortMapper_nomain.o jsonMapper/InOutPortMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/MessageEmissionMapper_nomain.o: ${OBJECTDIR}/jsonMapper/MessageEmissionMapper.o jsonMapper/MessageEmissionMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/MessageEmissionMapper_nomain.o jsonMapper/MessageEmissionMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/PortMapMapper_nomain.o: ${OBJECTDIR}/jsonMapper/PortMapMapper.o jsonMapper/PortMapMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/PortMapMapper_nomain.o jsonMapper/PortMapMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/ProcessMapper_nomain.o: ${OBJECTDIR}/jsonMapper/ProcessMapper.o jsonMapper/ProcessMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ProcessMapper_nomain.o jsonMapper/ProcessMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/ResultHandlingMapper_nomain.o: ${OBJECTDIR}/jsonMapper/ResultHandlingMapper.o jsonMapper/ResultHandlingMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ResultHandlingMapper_nomain.o jsonMapper/ResultHandlingMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/ThreadMapper_nomain.o: ${OBJECTDIR}/jsonMapper/ThreadMapper.o jsonMapper/ThreadMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ThreadMapper_nomain.o jsonMapper/ThreadMapper.cpp;\
	else  \
