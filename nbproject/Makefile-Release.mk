...
${OBJECTDIR}/StateMachineMapper.o: StateMachineMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StateMachineMapper.o StateMachineMapper.cpp
...
${OBJECTDIR}/StateMachineMapper_nomain.o: ${OBJECTDIR}/StateMachineMapper.o StateMachineMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StateMachineMapper_nomain.o StateMachineMapper.cpp;\
	else  \
