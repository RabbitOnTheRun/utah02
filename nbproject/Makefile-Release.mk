...
${OBJECTDIR}/ComponentSample1.o: ComponentSample1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComponentSample1.o ComponentSample1.cpp
...
${OBJECTDIR}/GuardIF.o: GuardIF.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GuardIF.o GuardIF.cpp
...
${OBJECTDIR}/MapOfGuard.o: MapOfGuard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapOfGuard.o MapOfGuard.cpp
...
${OBJECTDIR}/MessageWithInPort.o: MessageWithInPort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageWithInPort.o MessageWithInPort.cpp

${OBJECTDIR}/MessageWithOutPort.o: MessageWithOutPort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageWithOutPort.o MessageWithOutPort.cpp
...
${OBJECTDIR}/jsonMapper/ProcessMapper.o: jsonMapper/ProcessMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ProcessMapper.o jsonMapper/ProcessMapper.cpp
...
${OBJECTDIR}/jsonMapper/StateMachineMapper.o: jsonMapper/StateMachineMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/StateMachineMapper.o jsonMapper/StateMachineMapper.cpp
...
${OBJECTDIR}/jsonMapper/TransitionPartMapper.o: jsonMapper/TransitionPartMapper.cpp 
	${MKDIR} -p ${OBJECTDIR}/jsonMapper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/TransitionPartMapper.o jsonMapper/TransitionPartMapper.cpp
...
${TESTDIR}/tests/ActionIFtestclass.o: tests/ActionIFtestclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ActionIFtestclass.o tests/ActionIFtestclass.cpp


${TESTDIR}/tests/ActionIFtestrunner.o: tests/ActionIFtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ActionIFtestrunner.o tests/ActionIFtestrunner.cpp
...
${TESTDIR}/tests/GuardIFtestclass1.o: tests/GuardIFtestclass1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GuardIFtestclass1.o tests/GuardIFtestclass1.cpp


${TESTDIR}/tests/GuardIFtestrunner1.o: tests/GuardIFtestrunner1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GuardIFtestrunner1.o tests/GuardIFtestrunner1.cpp
...
${TESTDIR}/tests/MapOfGuardtestclass.o: tests/MapOfGuardtestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MapOfGuardtestclass.o tests/MapOfGuardtestclass.cpp


${TESTDIR}/tests/MapOfGuardtestrunner.o: tests/MapOfGuardtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MapOfGuardtestrunner.o tests/MapOfGuardtestrunner.cpp
...
${TESTDIR}/tests/PortMapMappertestclass.o: tests/PortMapMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PortMapMappertestclass.o tests/PortMapMappertestclass.cpp


${TESTDIR}/tests/PortMapMappertestrunner.o: tests/PortMapMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PortMapMappertestrunner.o tests/PortMapMappertestrunner.cpp


${TESTDIR}/tests/ProcessMapperPushtestclass.o: tests/ProcessMapperPushtestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMapperPushtestclass.o tests/ProcessMapperPushtestclass.cpp


${TESTDIR}/tests/ProcessMapperPushtestrunner.o: tests/ProcessMapperPushtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMapperPushtestrunner.o tests/ProcessMapperPushtestrunner.cpp


${TESTDIR}/tests/ProcessMappertestclass.o: tests/ProcessMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMappertestclass.o tests/ProcessMappertestclass.cpp


${TESTDIR}/tests/ProcessMappertestrunner.o: tests/ProcessMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcessMappertestrunner.o tests/ProcessMappertestrunner.cpp
...
${TESTDIR}/tests/StateMachineMappertestclass.o: tests/StateMachineMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StateMachineMappertestclass.o tests/StateMachineMappertestclass.cpp


${TESTDIR}/tests/StateMachineMappertestrunner.o: tests/StateMachineMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StateMachineMappertestrunner.o tests/StateMachineMappertestrunner.cpp


${TESTDIR}/tests/StateMachinetestclass.o: tests/StateMachinetestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StateMachinetestclass.o tests/StateMachinetestclass.cpp


${TESTDIR}/tests/StateMachinetestrunner.o: tests/StateMachinetestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StateMachinetestrunner.o tests/StateMachinetestrunner.cpp
...
${TESTDIR}/tests/ThreadMapper2testclass.o: tests/ThreadMapper2testclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMapper2testclass.o tests/ThreadMapper2testclass.cpp


${TESTDIR}/tests/ThreadMapper2testrunner.o: tests/ThreadMapper2testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMapper2testrunner.o tests/ThreadMapper2testrunner.cpp


${TESTDIR}/tests/ThreadMappertestclass.o: tests/ThreadMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMappertestclass.o tests/ThreadMappertestclass.cpp


${TESTDIR}/tests/ThreadMappertestrunner.o: tests/ThreadMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ThreadMappertestrunner.o tests/ThreadMappertestrunner.cpp


${TESTDIR}/tests/Transition2testclass.o: tests/Transition2testclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Transition2testclass.o tests/Transition2testclass.cpp


${TESTDIR}/tests/Transition2testrunner.o: tests/Transition2testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Transition2testrunner.o tests/Transition2testrunner.cpp
...
${TESTDIR}/tests/TransitionPartMappertestclass.o: tests/TransitionPartMappertestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TransitionPartMappertestclass.o tests/TransitionPartMappertestclass.cpp


${TESTDIR}/tests/TransitionPartMappertestrunner.o: tests/TransitionPartMappertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TransitionPartMappertestrunner.o tests/TransitionPartMappertestrunner.cpp
...
${OBJECTDIR}/ComponentSample1_nomain.o: ${OBJECTDIR}/ComponentSample1.o ComponentSample1.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComponentSample1_nomain.o ComponentSample1.cpp;\
	else  \
...
${OBJECTDIR}/GuardIF_nomain.o: ${OBJECTDIR}/GuardIF.o GuardIF.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GuardIF_nomain.o GuardIF.cpp;\
	else  \
...
${OBJECTDIR}/MapOfGuard_nomain.o: ${OBJECTDIR}/MapOfGuard.o MapOfGuard.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MapOfGuard_nomain.o MapOfGuard.cpp;\
	else  \
...
${OBJECTDIR}/MessageWithInPort_nomain.o: ${OBJECTDIR}/MessageWithInPort.o MessageWithInPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageWithInPort_nomain.o MessageWithInPort.cpp;\
	else  \
...
${OBJECTDIR}/MessageWithOutPort_nomain.o: ${OBJECTDIR}/MessageWithOutPort.o MessageWithOutPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageWithOutPort_nomain.o MessageWithOutPort.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/ProcessMapper_nomain.o: ${OBJECTDIR}/jsonMapper/ProcessMapper.o jsonMapper/ProcessMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/ProcessMapper_nomain.o jsonMapper/ProcessMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/StateMachineMapper_nomain.o: ${OBJECTDIR}/jsonMapper/StateMachineMapper.o jsonMapper/StateMachineMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/StateMachineMapper_nomain.o jsonMapper/StateMachineMapper.cpp;\
	else  \
...
${OBJECTDIR}/jsonMapper/TransitionPartMapper_nomain.o: ${OBJECTDIR}/jsonMapper/TransitionPartMapper.o jsonMapper/TransitionPartMapper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonMapper/TransitionPartMapper_nomain.o jsonMapper/TransitionPartMapper.cpp;\
	else  \
